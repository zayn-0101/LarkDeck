  ...
  entries:
    larkdeck:
      settings:
        ...
        text_profile: "compact"  # CardKit 设备字号：compact/off/mobile_friendly/large；细节行与 Error 块（markdown 宿主）为字面量 x-small，不随档位放大
