...
**回退**：`git checkout <tag>` 后重启。**已发布**：`v0.7.1`（上一版）、`v0.6.4` … `v0.6.0`、`v0.5.0`、`v0.4.0`、`v0.3.0`、`v0.2.0`，`v0.1.0` 是内部基线 tag（未建 Release）；`v0.7.2` 代码与门禁已收口，**等用户真机终验后**打 tag 发布。
