...
| **09-18 00:25–02:12（Phase 4 release 候选，最终）** | **382** | **382** | 0 | 0 | 0 | 0 | **8/8** | **EXIT=0 ✅** —— 颜色默认翻转 + release-gate 修正后的工作树（基于 `bdedb9b`）；四门禁全绿（`test_units 225/225`）、preflight 390/390（382+8）；末行「全部 382 条变异都被门禁抓住 ✅」；发布物见 `docs/releases/v0.6.0.md` | `docs/audits/cls-ui/phase-4/logs/fullrun_v0.6.0.log`（sha256 `70e28b6b…`，64,725 B） |
